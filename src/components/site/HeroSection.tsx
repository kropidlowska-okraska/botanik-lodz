  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-hidden
      />
      <div className="relative mx-auto flex min-h-[min(85vh,720px)] max-w-7xl flex-col justify-end px-4 pb-24 pt-24 sm:px-6 sm:pb-16">
        {topLeftCta ? (
        ...
        <h1
          id={titleId}
          className="max-w-7xl font-extrabold uppercase tracking-tight text-white drop-shadow-md"
        >
